...
export default function AdminScreen() {
  ...
  const buildHtmlReport = useCallback((snap: any): string => {
    ...
    sections.push(section("Riepilogo", kv({
      ...
      "Nuovi (24h)": ov.users?.signups_24h,
      "Nuovi (7g)": ov.users?.signups_7d,
      "Nuovi (30g)": ov.users?.signups_30d,
      "Voti totali": ov.engagement?.total_votes,
      "Voti (24h)": ov.engagement?.votes_24h,
      "Voti (7g)": ov.engagement?.votes_7d,
      "Voti (30g)": ov.engagement?.votes_30d,
      "Commenti totali": ov.engagement?.total_comments,
      "Commenti (24h)": ov.engagement?.comments_24h,
      "Commenti (7g)": ov.engagement?.comments_7d,
      "DAU": ov.active_users?.dau,
      "WAU": ov.active_users?.wau,
      "MAU": ov.active_users?.mau,
      "WAU/MAU (%)": ov.active_users?.wau_mau_ratio_pct,
